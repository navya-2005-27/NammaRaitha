...
export default function CenterPanel({ visible, onLanguageSelected }: { visible: boolean; onLanguageSelected: (lang: Language) => void }) {
  ...
  return (
    <div className={`absolute inset-0 flex items-center justify-center transition-opacity duration-700 ${visible ? "opacity-100" : "opacity-0 pointer-events-none"}`}>
      <div className="flex flex-col items-center gap-6">
        ...
        {selected && (
          <button
            ...
            style={{ background: "linear-gradient(90deg, #00F0FF, #4CAF50)", boxShadow: "0 8px 24px rgba(0,0,0,0.2)" }}
