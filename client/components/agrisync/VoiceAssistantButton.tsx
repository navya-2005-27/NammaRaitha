...
export default function VoiceAssistantButton() {
  ...
  const startListening = async () => {
    ...
    if (SR) {
      ...
      setListening(true);
      if (supports)
        speak("How can I help your farm today? You can type your command.", {
          lang: "en-IN",
        });
    }
  };
      ...
      {listening && (
        ...
        >
          ...
          >
            ...
            <div className="min-h-[60px] p-3 rounded-lg bg-gray-50 border text-gray-700">
              {transcript || "Say: Check soil moisture"}
            </div>
            {!(
              (window as any).SpeechRecognition ||
              (window as any).webkitSpeechRecognition
