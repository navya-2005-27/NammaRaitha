...
export default function TechPanel({ merged }: { merged: boolean }) {
  return (
    <div className={`relative h-full w-full overflow-hidden bg-[hsl(var(--agri-navy))] ${merged ? "shadow-2xl" : ""}`}>
      <div className="absolute inset-0 opacity-30" style={{ backgroundImage: `linear-gradient(rgba(0,240,255,0.08) 1px, transparent 1px), linear-gradient(90deg, rgba(0,240,255,0.08) 1px, transparent 1px)`, backgroundSize: "40px 40px" }} />
      ...
      <div className="absolute inset-x-0 top-6 text-center text-[hsl(var(--glow-white))] tracking-widest font-semibold">TECH</div>
