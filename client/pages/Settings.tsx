      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="rounded-2xl border bg-white/80 backdrop-blur p-6">
          <div className="mb-4">
            ...
            <select value={lang} onChange={(e) => setLang(e.target.value as any)} className="rounded-xl border px-3 py-2 bg-white">
          ...
          <div className="text-sm text-gray-600">More settings coming soon.</div>
        </div>
      </div>
    </div>
  );
